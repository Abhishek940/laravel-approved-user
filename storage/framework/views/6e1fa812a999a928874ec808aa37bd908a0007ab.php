...
<div class="tile">
<form action="<?php echo e(route('permission-submit')); ?>" method="POST" role="form" enctype="multipart/form-data">
  <?php echo csrf_field(); ?>
<div class="tile-body">
...
<?php echo $__env->make('auth.User.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-task\auth-role\resources\views/auth/User/permissions/create-permission.blade.php ENDPATH**/ ?>