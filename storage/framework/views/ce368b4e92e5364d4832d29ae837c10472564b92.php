...
<form action="<?php echo e(route('role-submit')); ?>" method="POST" role="form" enctype="multipart/form-data" id="myForm">
  <?php echo csrf_field(); ?>
<div class="tile-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('auth.User.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-task\auth-role\resources\views/auth/User/roles/create-role.blade.php ENDPATH**/ ?>